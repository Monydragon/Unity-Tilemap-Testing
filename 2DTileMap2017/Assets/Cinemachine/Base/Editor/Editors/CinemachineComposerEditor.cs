...
namespace Cinemachine.Editor
{
    ...
    internal class CinemachineComposerEditor : UnityEditor.Editor
    {
        ...
        protected virtual void OnGUI()
        {
            ...
            // Screen guides
            mScreenGuideEditor.OnGUI_DrawGuides(isLive, brain.OutputCamera, Target.VcamState.Lens);

            // Draw an on-screen gizmo for the target
            if (Target.LookAtTarget != null && isLive)
            {
                Vector2 targetScreenPosition = brain.OutputCamera.WorldToScreenPoint(Target.VcamState.ReferenceLookAt);
