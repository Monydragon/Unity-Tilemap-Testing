...
Thanks for purchasing Time Fantasy! :)

This resource pack contains a collection of tiles and characters in a retro-inspired fantasy theme. 
...
After the Resource Pack, "Time Fantasy" is completely downloaded to your computer, unzip it and place the folder in your desired location. 

1. Open RPG Maker VX Ace:
Open RPG Maker VX Ace and the project you wish to add the Resource Pack to. Select Resource Manager -----> Graphics/Tilesets or Graphics/Characters -----> Import -----> Choose the resource files and then import them.
...
+++++++++++++++++++++++++++++++++++++++++++++++++
+
+   Time Fantasy END USER LICENSE AGREEMENT
+
+++++++++++++++++++++++++++++++++++++++++++++++++
...
1. Copyright, trademark and other intellectual property rights of Time Fantasy (the "Product") are property of DEGICA Co., LTD (the "Company" or "DEGICA") and third party allowed by the Company.
...
2.5 Do not sell, distribute, lease, or transfer the Resource Pack itself or any of its parts (even if the materials were edited, processed, or modified by the User). 
