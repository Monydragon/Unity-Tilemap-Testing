...
READ THIS CAREFULLY BEFORE INSTALLING OR USING Royal Tiles Resource Pack.

I. Introduction

Thank you for purchasing the Resource Pack, "Royal Tiles Resource Pack". 

This Resource Pack contains tiles that can be used in a royal or castle setting. This Pack is compatible with the full version of "RPG MAKER VX, RPG Maker XP, and RPG Maker VX Ace" and can be used with IG Maker to create your own game. You may NOT use the resources in this pack for creating games made with engines/programs other than RPG Maker and IG Maker.
...
After the Resource Pack, "Royal Tiles Resource Pack" is completely downloaded to your computer, unzip it and place the folder in your desired location. 
...
Open RPG Maker VX Ace and the project you wish to add the Resource Pack to. Select Tools -----> Resource Manager -----> Graphics/Tiles or Graphics/Characters ---------> Import --------> Choose the resource files and then import them. 
...
V. "Royal Tiles Resource Pack" END USER LICENSE AGREEMENT
...
1. Copyright, trademark and other intellectual property rights of Royal Tiles Resource Pack (the "Product") are property of ENTERBRAIN, INC (the "Company" or "ENTERBRAIN") and third party allowed by the Company. 
